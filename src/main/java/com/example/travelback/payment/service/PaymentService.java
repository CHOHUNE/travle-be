...
//import com.example.travelback.payment.dto.PaymentSuccessDto;
//import com.example.travelback.payment.exception.CustomLogicException;
//import com.example.travelback.payment.exception.ExceptionCode;
...
//
//    public PaymentResDto requsetTossPayment(PaymentDto paymentDto, String userEmail) throws CustomLogicException {
...
//        }
//        payment.setMemberId(memberMapper.findIdByEmail(userEmail));
...
//        paymentResDto.setCustomerEmail(userEmail);
...
//        PaymentSuccessDto result = requsetPaymentAccept(paymentKey, orderId, amount);
...
//    }
//
//    public PaymentSuccessDto requsetPaymentAccept(String paymentKey, String orderId, Long amount) {
